 ...
 * 15-brandId.js
 * Pool BrandId Script
 * Purpose: Gets the brand ID of the pool
 */
...
async function runBrandId(userPrivateKey = null) {
    try {
        console.log('🚀 Starting BrandId Script...');
        ...
        console.log('🎯 BrandId Parameters:');
        ...
        const result = await Pool.brandId();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 BrandId completed successfully!');
