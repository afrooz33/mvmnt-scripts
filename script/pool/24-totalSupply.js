/**
 * 24-totalSupply.js
 * Pool TotalSupply Script
 * Purpose: Gets the total supply of LP tokens
 */
...
async function runTotalSupply(userPrivateKey = null) {
    try {
        console.log('🚀 Starting TotalSupply Script...');
        ...
        console.log('🎯 TotalSupply Parameters:');
        ...
        console.log('🎉 TotalSupply completed successfully!');
