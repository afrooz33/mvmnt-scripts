/**
 * 10-emergencyWithdraw.js
 * Pool EmergencyWithdraw Script
...
async function runEmergencyWithdraw(token, to, amount, userPrivateKey = null) {
    try {
        ...
        const tx = await Pool.emergencyWithdraw(token, to, amountWei);
...
if (require.main === module) {
    ...
    if (!token || !to || !amount) {
        console.error('❌ Usage: node 10-emergencyWithdraw.js "0x123..." "0x456..." 1000');
        process.exit(1);
    }
