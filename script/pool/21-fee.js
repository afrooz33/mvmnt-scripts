 ...
 * 21-fee.js
 * Pool Fee Script
 * Purpose: Gets the current trading fee
 */
...
async function runFee(userPrivateKey = null) {
    try {
        console.log('🚀 Starting Fee Script...');
        ...
        const result = await Pool.fee();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 Fee completed successfully!');
        ...
        console.error('❌ Fee failed:', error.message);
