/**
 * 22-totalLPTokens.js
 * LPManager TotalLPTokens Script
 * Purpose: Gets total LP tokens for a brand
 */
...
async function runTotalLPTokens(brandId, userPrivateKey = null) {
    try {
        console.log('🚀 Starting TotalLPTokens Script...');
        ...
        console.log('🎯 TotalLPTokens Parameters:');
        ...
        const result = await LPManager.totalLPTokens(brandIdWei);
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 TotalLPTokens completed successfully!');
        ...
        console.error('❌ TotalLPTokens failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId) {
        console.error('❌ Usage: node 22-totalLPTokens.js 123');
        process.exit(1);
    }
    
    runTotalLPTokens(brandId, userPrivateKey)
        .then(result => {
...
module.exports = { runTotalLPTokens };