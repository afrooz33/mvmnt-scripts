/**
 * 25-btManager.js
 * LPManager BtManager Script
 * Purpose: Gets BT manager address
 */
...
async function runBtManager(userPrivateKey = null) {
    try {
        console.log('🚀 Starting BtManager Script...');
        ...
        console.log('🎯 BtManager Parameters:');
        ...
        const result = await LPManager.btManager();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 BtManager completed successfully!');
        ...
        console.error('❌ BtManager failed:', error.message);
