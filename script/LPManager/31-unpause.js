/**
 * 31-unpause.js
 * LPManager Unpause Script
 * Purpose: Unpauses the LPManager contract
 */
...
async function runUnpause(userPrivateKey = null) {
    try {
        ...
        const tx = await LPManager.unpause();
