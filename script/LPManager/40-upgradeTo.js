/**
 * 40-upgradeTo.js
 * LPManager UpgradeTo Script
 * Purpose: Upgrades contract implementation
 */
...
async function runUpgradeTo(newImplementation, userPrivateKey = null) {
    try {
        console.log('🚀 Starting UpgradeTo Script...');
        ...
        console.log('🎯 UpgradeTo Parameters:');
        ...
        const tx = await LPManager.upgradeTo(newImplementation);
        ...
        console.log('🎉 UpgradeTo completed successfully!');
        ...
        console.error('❌ UpgradeTo failed:', error.message);
...
if (require.main === module) {
    ...
    if (!newImplementation) {
        console.error('❌ Usage: node 40-upgradeTo.js "0x123..."');
        process.exit(1);
    }
    
    runUpgradeTo(newImplementation, userPrivateKey)
        .then(result => {
