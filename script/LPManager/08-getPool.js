/**
 * 08-getPool.js
 * LPManager GetPool Script
 * Purpose: Gets pool information
 */
...
async function runGetPool(brandId, userPrivateKey = null) {
    try {
        console.log('🚀 Starting GetPool Script...');
        ...
        console.log('🎯 GetPool Parameters:');
        ...
        const result = await LPManager.getPool(brandIdWei);
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 GetPool completed successfully!');
        ...
        console.error('❌ GetPool failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId) {
        console.error('❌ Usage: node 08-getPool.js 123');
        process.exit(1);
    }
    
    runGetPool(brandId, userPrivateKey)
        .then(result => {
