/**
 * 12-claimLPProviderFees.js
 * LPManager ClaimLPProviderFees Script
 * Purpose: Claims LP provider fees
 */
...
async function runClaimLPProviderFees(brandId, userPrivateKey = null) {
    try {
        console.log('🚀 Starting ClaimLPProviderFees Script...');
        ...
        console.log('🎯 ClaimLPProviderFees Parameters:');
        ...
        const tx = await LPManager.claimLPProviderFees(brandIdWei);
        ...
        console.log('🎉 ClaimLPProviderFees completed successfully!');
        ...
        console.error('❌ ClaimLPProviderFees failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId) {
        console.error('❌ Usage: node 12-claimLPProviderFees.js 123');
        process.exit(1);
    }
    
    runClaimLPProviderFees(brandId, userPrivateKey)
        .then(result => {
...
module.exports = { runClaimLPProviderFees };