/**
 * 11-claimBTStakerFees.js
 * LPManager ClaimBTStakerFees Script
 * Purpose: Claims BT staker fees
 */
...
async function runClaimBTStakerFees(brandId, userPrivateKey = null) {
    try {
        console.log('🚀 Starting ClaimBTStakerFees Script...');
        ...
        console.log('🎯 ClaimBTStakerFees Parameters:');
        ...
        const tx = await LPManager.claimBTStakerFees(brandIdWei);
        ...
        console.log('🎉 ClaimBTStakerFees completed successfully!');
        ...
        console.error('❌ ClaimBTStakerFees failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId) {
        console.error('❌ Usage: node 11-claimBTStakerFees.js 123');
        process.exit(1);
    }
    
    runClaimBTStakerFees(brandId, userPrivateKey)
        .then(result => {
...
module.exports = { runClaimBTStakerFees };