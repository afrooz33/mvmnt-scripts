/**
 * 30-pause.js
 * LPManager Pause Script
 * Purpose: Pauses the LPManager contract
 */
...
async function runPause(userPrivateKey = null) {
    try {
        ...
        const tx = await LPManager.pause();
