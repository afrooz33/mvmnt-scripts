/**
 * 38-renounceOwnership.js
 * LPManager RenounceOwnership Script
 * Purpose: Renounces contract ownership
 */
...
async function runRenounceOwnership(userPrivateKey = null) {
    try {
        console.log('🚀 Starting RenounceOwnership Script...');
        ...
        console.log('🎯 RenounceOwnership Parameters:');
        ...
        const tx = await LPManager.renounceOwnership();
        ...
        console.log('🎉 RenounceOwnership completed successfully!');
        ...
        console.error('❌ RenounceOwnership failed:', error.message);
...
if (require.main === module) {
    ...
    runRenounceOwnership(userPrivateKey)
        .then(result => {
...
module.exports = { runRenounceOwnership };