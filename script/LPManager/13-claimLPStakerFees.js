/**
 * 13-claimLPStakerFees.js
 * LPManager ClaimLPStakerFees Script
 * Purpose: Claims LP staker fees
 */
...
async function runClaimLPStakerFees(brandId, userPrivateKey = null) {
    try {
        console.log('🚀 Starting ClaimLPStakerFees Script...');
        ...
        console.log('🎯 ClaimLPStakerFees Parameters:');
        ...
        const tx = await LPManager.claimLPStakerFees(brandIdWei);
        ...
        console.log('🎉 ClaimLPStakerFees completed successfully!');
        ...
        console.error('❌ ClaimLPStakerFees failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId) {
        console.error('❌ Usage: node 13-claimLPStakerFees.js 123');
        process.exit(1);
    }
    
    runClaimLPStakerFees(brandId, userPrivateKey)
        .then(result => {
...
module.exports = { runClaimLPStakerFees };