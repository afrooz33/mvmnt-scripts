/**
 * 21-userLPTokens.js
 * LPManager UserLPTokens Script
 * Purpose: Gets user LP tokens for a brand
 */
...
async function runUserLPTokens(brandId, user, userPrivateKey = null) {
    try {
        console.log('🚀 Starting UserLPTokens Script...');
        ...
        console.log('🎯 UserLPTokens Parameters:');
        ...
        const result = await LPManager.userLPTokens(brandIdWei, user);
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 UserLPTokens completed successfully!');
        ...
        console.error('❌ UserLPTokens failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId || !user) {
        console.error('❌ Usage: node 21-userLPTokens.js 123 "0x123..."');
        process.exit(1);
    }
    
    runUserLPTokens(brandId, user, userPrivateKey)
        .then(result => {
...
module.exports = { runUserLPTokens };