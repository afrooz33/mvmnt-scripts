/**
 * 36-owner.js
 * LPManager Owner Script
 * Purpose: Gets contract owner address
 */
...
async function runOwner(userPrivateKey = null) {
    try {
        console.log('🚀 Starting Owner Script...');
        ...
        const result = await LPManager.owner();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 Owner completed successfully!');
