/**
 * 28-dexRouter.js
 * LPManager DexRouter Script
 * Purpose: Gets DEX router address
 */
...
async function runDexRouter(userPrivateKey = null) {
    try {
        console.log('🚀 Starting DexRouter Script...');
        ...
        console.log('🎯 DexRouter Parameters:');
        ...
        const result = await LPManager.dexRouter();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 DexRouter completed successfully!');
        ...
        console.error('❌ DexRouter failed:', error.message);
