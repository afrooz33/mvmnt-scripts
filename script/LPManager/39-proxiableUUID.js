/**
 * 39-proxiableUUID.js
 * LPManager ProxiableUUID Script
 * Purpose: Gets proxiable UUID
 */
...
async function runProxiableUUID(userPrivateKey = null) {
    try {
        console.log('🚀 Starting ProxiableUUID Script...');
        ...
        console.log('🎯 ProxiableUUID Parameters:');
        ...
        const result = await LPManager.proxiableUUID();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 ProxiableUUID completed successfully!');
        ...
        console.error('❌ ProxiableUUID failed:', error.message);
...
if (require.main === module) {
    ...
    runProxiableUUID(userPrivateKey)
        .then(result => {
...
module.exports = { runProxiableUUID };