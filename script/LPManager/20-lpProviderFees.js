/**
 * 20-lpProviderFees.js
 * LPManager LpProviderFees Script
 * Purpose: Gets LP provider fees for user
 */
...
async function runLpProviderFees(brandId, user, userPrivateKey = null) {
    try {
        console.log('🚀 Starting LpProviderFees Script...');
        ...
        console.log('🎯 LpProviderFees Parameters:');
        ...
        const result = await LPManager.lpProviderFees(brandIdWei, user);
        
        
        console.log('📊 Result:', result.toString());
        
        console.log('🎉 LpProviderFees completed successfully!');
        ...
        console.error('❌ LpProviderFees failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId || !user) {
        console.error('❌ Usage: node 20-lpProviderFees.js 123 "0x123..."');
        process.exit(1);
    }
    
    runLpProviderFees(brandId, user, userPrivateKey)
        .then(result => {
...
module.exports = { runLpProviderFees };