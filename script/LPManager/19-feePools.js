/**
 * 19-feePools.js
 * LPManager FeePools Script
 * Purpose: Gets fee pool information
 */
...
async function runFeePools(brandId, userPrivateKey = null) {
    try {
        console.log('🚀 Starting FeePools Script...');
        ...
        console.log('🎯 FeePools Parameters:');
        ...
        const result = await LPManager.feePools(brandIdWei);
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 FeePools completed successfully!');
        ...
        console.error('❌ FeePools failed:', error.message);
...
if (require.main === module) {
    ...
    if (!brandId) {
        console.error('❌ Usage: node 19-feePools.js 123');
        process.exit(1);
    }
    
    runFeePools(brandId, userPrivateKey)
        .then(result => {
