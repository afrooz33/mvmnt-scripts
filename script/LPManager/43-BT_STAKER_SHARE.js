/**
 * 43-BT_STAKER_SHARE.js
 * LPManager BT_STAKER_SHARE Script
 * Purpose: Gets BT staker share constant
 */
...
async function runBT_STAKER_SHARE(userPrivateKey = null) {
    try {
        console.log('🚀 Starting BT_STAKER_SHARE Script...');
        ...
        console.log('🎯 BT_STAKER_SHARE Parameters:');
        ...
        const result = await LPManager.BT_STAKER_SHARE();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 BT_STAKER_SHARE completed successfully!');
        ...
        console.error('❌ BT_STAKER_SHARE failed:', error.message);
...
if (require.main === module) {
    ...
    runBT_STAKER_SHARE(userPrivateKey)
        .then(result => {
...
module.exports = { runBT_STAKER_SHARE };