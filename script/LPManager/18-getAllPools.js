/**
 * 18-getAllPools.js
 * LPManager GetAllPools Script
 * Purpose: Gets all pool brand IDs
 */
...
async function runGetAllPools(userPrivateKey = null) {
    try {
        console.log('🚀 Starting GetAllPools Script...');
        ...
        console.log('🎯 GetAllPools Parameters:');
        ...
        const result = await LPManager.getAllPools();
        
        
        console.log('📊 Result:', result);
        
        console.log('🎉 GetAllPools completed successfully!');
        ...
        console.error('❌ GetAllPools failed:', error.message);
