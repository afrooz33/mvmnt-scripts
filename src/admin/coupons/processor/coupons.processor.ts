...
import { CouponsService } from '@app/src/admin/coupons/coupons.service'

@Processor(BullMqQuery.ADMIN_COUPONS_QUEUE)
export class CouponProcessor extends WorkerHost {
  constructor(
  ...
  async process(job: Job<any>): Promise<any> {
    ...
    try {
      await this.couponsService.updateOne({
        id: job.data.id,
